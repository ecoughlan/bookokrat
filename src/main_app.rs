...
impl App {
    ...
    fn new_with_config_and_executor(
        ...
        text_reader.set_blind_scroll_speed(settings::get_blind_scroll_speed());
    ...
    fn dispatch_blind_action(&mut self, action: &crate::keybindings::action::Action) -> bool {
        ...
        let rows = match action {
            ...
            Action::IncreaseBlindScrollSpeed | Action::DecreaseBlindScrollSpeed => {
                ...
                settings::set_blind_scroll_speed(self.text_reader.get_blind_scroll_speed());
                return true;
            }
    ...
    fn dispatch_global_action(&mut self, action: crate::keybindings::action::Action) -> bool {
        ...
        match action {
            Action::StartBlindScroll => {
                if self.is_main_panel(MainPanel::Content) && !self.is_pdf_mode() {
                    if let Some(book) = self.current_book.as_ref() {
